...
const galleryItems = [
  ...
  },
  {
    id: 9,
    title: 'sakura',
    image: '/galleries/sakura.png',
    markSnapshotUrl: '/snapshots/sakuraMarks.json',
    collageSeriesSnapshotUrl: '/snapshots/sakuraCanvas.json',
    dataUrl: '/csv/workLife.csv',
    markLibUrls: [],
    containerUrls: [],
    backgroundUrl: '/background/sakura.jpg',
  },{
    id: 10,
    title: 'eater',
    image: '/galleries/eater.png',
    markSnapshotUrl: '/snapshots/eaterMarks.json',
    collageSeriesSnapshotUrl: '/snapshots/eaterCanvas.json',
    dataUrl: '/csv/bottleDream.csv',
    markLibUrls: [],
    containerUrls: [],
    backgroundUrl: '/background/eater.png',
  },
  {
    id: 11,
    title: 'luv',
    image: '/galleries/luv.png',
    markSnapshotUrl: '/snapshots/luvMarks.json',
    collageSeriesSnapshotUrl: '/snapshots/luvCanvas.json',
    dataUrl: '/csv/workLife.csv',
    markLibUrls: [],
    containerUrls: [],
    backgroundUrl: '/background/luv.png',
  },
  {
    id: 12,
    title: 'night',
    image: '/galleries/night.png',
    markSnapshotUrl: '/snapshots/nightMarks.json',
    collageSeriesSnapshotUrl: '/snapshots/nightCanvas.json',
    dataUrl: '/csv/bottleDream.csv',
    markLibUrls: [],
    containerUrls: [],
    backgroundUrl: '/background/night.jpg',
  }
]
