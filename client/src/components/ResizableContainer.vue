...
<template>
  <div ref="container" class="flex h-full w-full select-none relative overflow-hidden">
    ...
    <div class="h-full flex flex-col" :style="{ width: `${resizeHandleStore.rightWidth}px`, minWidth: `${minRightWidth}px` }">
      <!-- 工具栏 -->
      <div class="flex justify-between items-center p-2 border-b border-gray-200 bg-gray-50 h-8 flex-shrink-0 shadow-sm z-10">
        <span class="text-[14px] text-gray-600 font-bold">Canvas Editor</span>
      </div>
